                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-md-5 my-1">
                                                    <div class="form-floating ">
                                                        ...
                                                        <label class="text-secondary opacity-75">Contraseña</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-5 my-1">
                                                    <div class="form-floating ">
                                                ...
                                                <div class="col-md-5 my-1">
                                                    <div class="form-floating">
                                                        <select class="form-select"
                                                            v-model="user.account.Genero" aria-label="Floating label select example">
                                                ...
                                                <div class="col-md-5 my-1">
                                                    <div class="form-floating">
                                                        <select class="form-select"
                                                            v-model="user.account.TipoDocumento" aria-label="Floating label select example">
                                                ...
                                                <div class="col-md-5 my-1">
                                                    <div class="form-floating ">
                                                        <input required type="text" class="form-control"
                                                            v-model="user.account.NumeroDocumento" placeholder="Numero de documento">
                                                ...
                                                <div class="col-md-5 my-1">
                                                    <div class="form-floating ">
                                                        <input required type="date" class="form-control"
                                                            v-model="user.account.FechaNacimiento" placeholder="Fecha de nacimiento">
